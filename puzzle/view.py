...
import torch
from puzzle.train import TEST_BZ, fo_logic, DATA, MODEL_NAME


def init():
    _, view_set = get_train_and_test_dataset(DATA)
    view_loader = DataLoader(view_set, batch_size=TEST_BZ // 4, shuffle=True)
